...
+function ($) { "use strict";
  ...
  $(document).on('click.app.bjax.data-api', '[data-bjax], .nav-primary b', function (e) {
...
+function ($) {
  ...
  $(function(){
    ...
    $("[name=permissionPlus]").click(function(){
    	var parent=$(this);
    	var parentid=$(this).attr("permissionid");
    	
    	$("tr[parentid="+parentid+"]").toggle();
    	if($("tr[parentid="+parentid+"]").is(":hidden")){
    		parent.removeClass("fa-minus");
    		parent.addClass("fa-plus");
    	}else{
    		parent.removeClass("fa-plus");
    		parent.addClass("fa-minus");
    	}
    ...
    //禁用#链接跳转到根链接，定义了base的原因
    $("[href='#'],[href='#this']").click(function(){
    	//return false;
    });
